...
export const LEVELS = [
  ...
  // ── World 2: Ocean ───────────────────────────────────────────────────
  {
    ...
    objectives: [{ type: 'tiles_clear', target: 60 }],
    mechanics: [],
  },
  {
    id: 6, world: 2,
    cols: 7, rows: 8, timeLimit: 72,
    boardShape: 'corners-2',
    tileShape: 'circle', colors: 6,
    obstacles: [],
    specials: [{ type: 'stripe', chance: 0.06 }, { type: 'rainbow', chance: 0.015 }],
    objectives: [
      { type: 'tiles_clear', target: 62 },
      { type: 'color_clear', color: 4, target: 22 },
    ],
    mechanics: ['drift'],
  },
  {
  ...
  // ── World 3: Fire ────────────────────────────────────────────────────
  {
    ...
    objectives: [{ type: 'tiles_clear', target: 55 }],
    mechanics: [],
  },
  {
    id: 10, world: 3,
    ...
    boardShape: 'plus',
    tileShape: 'diamond', colors: 5,
    obstacles: [{ type: 'lava', count: 5 }],
    specials: [{ type: 'bomb', chance: 0.05 }, { type: 'stripe', chance: 0.06 }],
    objectives: [
      { type: 'tiles_clear', target: 65 },
      { type: 'color_clear', color: 0, target: 25 },
    ],
  ...
  },
  {
    ...
    boardShape: 'diamond',
    tileShape: 'diamond', colors: 5,
    obstacles: [{ type: 'lava', count: 7 }, { type: 'stone', count: 4 }],
  ...
  // ── World 4: Ice ─────────────────────────────────────────────────────
  {
    ...
    obstacles: [{ type: 'ice', count: 8 }],
    specials: [{ type: 'stripe', chance: 0.06 }, { type: 'bomb', chance: 0.04 }],
    objectives: [
      { type: 'tiles_clear', target: 45 },
      { type: 'break_ice', target: 8 },
    ],
    mechanics: [],
  },
  {
    ...
    boardShape: 'diamond',
    tileShape: 'hex', colors: 6,
    obstacles: [{ type: 'ice', count: 11 }, { type: 'stone', count: 4 }],
    specials: [{ type: 'stripe', chance: 0.07 }, { type: 'bomb', chance: 0.05 }],
    objectives: [{ type: 'break_ice', target: 11 }],
    mechanics: [],
  },
  {
    id: 15, world: 4,
  ...
  },
  {
    ...
    specials: [{ type: 'stripe', chance: 0.07 }, { type: 'bomb', chance: 0.06 }, { type: 'rainbow', chance: 0.03 }],
    objectives: [
      { type: 'tiles_clear', target: 75 },
      { type: 'bombs_triggered', target: 10 },
    ],
